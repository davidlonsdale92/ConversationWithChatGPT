...
class DialogBox(customtkinter.CTkFrame):
    ...
    def user_dialog(self, row, message):
        ...
        # FIXME: This frame doesn't sit correctly within the dialog frame. Padding needs adjusting. 
        self.textbox_frame = customtkinter.CTkFrame(
            master=self.dialogbox_frame, 
            fg_color=("#f7f7f8", "#40414e"),
        )
        self.textbox_frame.grid(row=1, column=0)
        ...
        self.textbox.grid(row=1, column=0, ipady=10, padx=(30,30), pady=(5,5))
